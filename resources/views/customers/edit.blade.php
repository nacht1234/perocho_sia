                ...
                <form method="POST" action="{{ route('customers.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 md:gap-x-6 gap-y-6">
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" value="{{ old('name', $customer->name ?? '') }}" required class="w-full border px-3 py-2 rounded" />
                            @error('name') <div class="text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div class="mb-4">
                            <label class="block">Age</label>
                            <input type="text" name="age" value="{{ old('age', $customer->age ?? '') }}" required class="w-full border px-3 py-2 rounded" />
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="phone" value="{{ old('phone', $customer->phone ?? '') }}" required class="w-full border px-3 py-2 rounded" />
